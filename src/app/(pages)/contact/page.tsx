...
export default function Contact() {
  ...
  return (
    <div className="w-full">
      <FloatingNavbar />
      <PageHero eyebrow="Reach Out" title="Let's Start a" titleAccent="Conversation" subtitle="Whether you want to volunteer, partner, donate, or simply learn more — we'd love to hear from you." />
